...
Você pode abrir o arquivo **index.html** no navegador para visualizar a página.
...
```
git clone https://github.com/SEU_USUARIO/discord-pagina-inicial.git
```

2. Abra o arquivo **index.html** em qualquer navegador.

Pronto! A página já funciona sem necessidade de servidor.
